      ...
      <footer className="bg-secondary rounded-t-lg mt-16">
        <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <p className="mx-auto mt-6 max-w-md text-center leading-relaxed text-gray-500">
            Campus Discovery is a free online lost and found website to help
            students and staff memebers of Dedan Kimathi University trace and
            find their lost belongings quickly.
          </p>
          ...
          <ul className="mt-12 flex justify-center gap-6 md:gap-8">
            <li>
              <a
                ...
                rel="noreferrer"
                target="_blank"
                className="text-gray-700 transition hover:text-accent"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/omutelema-silas-abelbel-008879271/"
                rel="noreferrer"
                target="_blank"
                className="text-gray-700 transition hover:text-accent"
              >
